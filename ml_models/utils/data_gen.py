...
default_data_parent_dir = os.path.abspath('../data/molecules')
...
class GenCreator(keras.utils.Sequence):
    def __init__(self,
                 batch_size,
                 dirs_file,
                 labels_store,
                 ...
                 dshape='rect',
                 out='gp2', 
                 parent_dir = default_data_parent_dir,
                 verbose=0,
                 name=None,
                 cube_clip=None,
                 pot_clip=None):
    ...
    def __data_generation(self, batch_dirs, index):
        ...
        for act_dir in batch_dirs:
            ...
            labels_array.append(self.labels[self.out].loc[df_idx])
        ...
        return np.array(cube_array), np.array(labels_array)
